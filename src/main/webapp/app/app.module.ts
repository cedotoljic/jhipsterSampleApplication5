...
import { JhipsterSampleApplication5SharedModule, UserRouteAccessService } from './shared';
...
import { JhipsterSampleApplication5AdminModule } from './admin/admin.module';
...
@NgModule({
    imports: [
        ...
        JhipsterSampleApplication5AdminModule,
